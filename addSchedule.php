...
<div class="container-fluid">
    <div class="row" id="location_modal">
        <div class="col-6 border-left" id="frm-field">
            ...
            <hr>
            <form id="schedule_form" onclick="return dateChecker()">
            ...
            <input type="hidden" name="date_sched" value="<?php echo $_GET['d'] ?>">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" required pattern="[a-zA-Z]{3,25}$">
                </div>
                <div class="form-group">
				...
				<div class="form-group">
                    <label for="contact" class="control-label">Adhaar Number</label>
                    <input type="text" class="form-control" name="adhaar" required pattern="[0-9]{12}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="dobage" class="form-control" name="dob" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group d-flex justify-content-end">
                    <button class="btn-dark btn" id="btn_sub">Submit Schedule</button>
                </div>
            </form>
        </div>
        <div class="col-6">
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
                        ...
                        var ins = "<small><i>Copy or take a snapshot of the code below your name. The code will serve as your ticket number for vaccination schedule. Please bring your Adhaar card to verify your schedule information.</i></small>";
...
function dateChecker(){
	const dobage = document.getElementById("dobage");
					...
					var yyyy = validMinDate.getFullYear() -18;
